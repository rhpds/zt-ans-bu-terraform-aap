...
slug: tf-basics-certified id: mdjcxiwmpms0 type: challenge title: OPTIONAL - Terraform and the Certified Collection for Terraform teaser: Several years ago Red Hat released a certified collection for Terraform, in   this exercise you will use some of the components at the Command Line notes:

* type: text contents: |-   # OPTIONAL - Terraform and the Certified Collection for Terraform   image:https://github.com/HichamMourad/terraform-aap/blob/main/images/main.png?raw=true[]   Welcome!!!
 ** Grab a Coffee/Tea
 ** Sit back and relax
...
* id: xq3dimvgtnhw title: Terminal type: terminal hostname: devhost workdir: /home/rhel/lab_exercises/ cmd: su - rhel
* id: h4shebiyjafa title: VSCode type: service hostname: devhost path: /editor/?folder=/home/rhel/lab_exercises port: 443
* id: ymresn5vwmfw title: AWS Console type: service hostname: cloud-client path: / port: 80
* id: jifkfild53fz title: Ansible Automation Platform type: service hostname: controller port: 443 difficulty: "" timelimit: 900 enhanced_loading: null -- 👋 Challenge introduction.
===
+
